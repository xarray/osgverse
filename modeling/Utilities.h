...
namespace osgVerse
{
    ...
    public:
        ...
        */
        ...
        /** Return value as a set of "near" convex parts, generated by COACD
            Concavity Threshold: 0.01 (very similar) - 1 (very rough)
        */
        osg::Geometry* computeCoACD(float threshold = 0.05f, int maxConvexHull = -1, bool merge = true,
                                    bool decimate = true, bool extrude = false, bool approxByCubes = false);
