...
{
public:
    SpecularmapGenerator(IntensityMap::Mode mode, double redMultiplier, double greenMultiplier,
                         double blueMultiplier, double alphaMultiplier);
    osg::Image* calculateSpecmap(osg::Image* input, double scale, double contrast);
