...
public:
    ...
    osg::Image* calculateNormalmap(osg::Image* input, Kernel kernel, double strength = 2.0, bool invert = false,
...
private:
    ...
    osg::Vec3d sobel(const double convolution_kernel[3][3], double strengthInv) const;
    osg::Vec3d prewitt(const double convolution_kernel[3][3], double strengthInv) const;
