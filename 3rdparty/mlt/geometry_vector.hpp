...
struct FlatGpuVector : public GpuVector {
    ...
    bool containsPolygonGeometry() const noexcept override {
        ...
        //return std::ranges::any_of(geometryTypes, [](const auto type) {  // WangRui 202602: downgrade to C++17
        return std::any_of(geometryTypes.begin(), geometryTypes.end(), [](const auto type) {  ////
