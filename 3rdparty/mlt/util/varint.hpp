...
/*template <typename T>
    requires(std::is_integral_v<T>)*/  // WangRui 202602: downgrade to C++17
template <typename T>
////
...
/*template <typename T>
    requires(std::is_enum_v<T>)*/  // WangRui 202602: downgrade to C++17
template <typename T>
////
...
/*template <typename T, std::size_t N>
    requires(std::is_integral_v<T> || std::is_enum_v<T>, 0 < N)*/  // WangRui 202602: downgrade to C++17
template <typename T, std::size_t N>
////
...
/*template <typename TDecode, typename TTarget = TDecode>
    requires(std::is_integral_v<TDecode> && (std::is_integral_v<TTarget> || std::is_enum_v<TTarget>) &&
             sizeof(TDecode) <= sizeof(TTarget))*/  // WangRui 202602: downgrade to C++17
template <typename TDecode, typename TTarget = TDecode>
////
