        ...
        switch (typeCode) {
            ...
            case 3:
                return Column{/*.name =*/ {},
                              ...
                              /*.type =*/ ScalarColumn{LogicalScalarType::ID, typeCode > 1}};
            case 4:
                return Column{/*.name =*/ {},
                              /*.nullable =*/ false,
                              /*.columnScope =*/ ColumnScope::FEATURE,
                              /*.type =*/ ComplexColumn{ComplexType::GEOMETRY}};
            case 30:
                return Column{/*.name =*/ {},
                              /*.nullable =*/ false,
                              /*.columnScope =*/ ColumnScope::FEATURE,
                              /*.type =*/ ComplexColumn{ComplexType::STRUCT}};
            default:
                if (const auto type = mapScalarType(typeCode); type) {
                    return Column{/*.name =*/ {},
                                  /*.nullable =*/ (typeCode & 1) != 0,
                                  /*.columnScope =*/ ColumnScope::FEATURE,
                                  /*.type =*/ ScalarColumn{*type, false}};
                }
                return std::nullopt;
        }
    }
