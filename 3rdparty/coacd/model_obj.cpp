...
namespace coacd
{
    ...
    void Model::ComputeVCH(Model &convex)
    {
        ...
        {
            const btConvexHullComputer2::Edge *sourceEdge = &(ch.edges[ch.faces[t]]);
            int32_t a = sourceEdge->getSourceVertex();
            int32_t b = sourceEdge->getTargetVertex();
            const btConvexHullComputer2::Edge *edge = sourceEdge->getNextEdgeOfFace();
