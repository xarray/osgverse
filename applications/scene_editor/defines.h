...
#endif
USE_SERIALIZER_INTERFACE(StateSet)
USE_SERIALIZER_INTERFACE(VertexArray)
USE_SERIALIZER_INTERFACE(NormalArray)
USE_SERIALIZER_INTERFACE(ColorArray)
USE_SERIALIZER_INTERFACE(TexCoordArrayList)
USE_SERIALIZER_INTERFACE(VertexAttribArrayList)
USE_SERIALIZER_INTERFACE(PrimitiveSetList)
USE_SERIALIZER_INTERFACE(Shaders)
