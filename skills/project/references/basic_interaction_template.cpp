// ============================================
// 鼠标/键盘事件，场景射线/鼠标点击求交实现标准模板
// @skill-status: partial
// @skill-category: interaction, mouse event, keyboard event, ray intersection, pick
// @dependencies: osgVerseReaderPipeline
// 
...
// 需要添加在代码文件起始位置的头文件
#include <osgVerse/pipeline/IntersectionManager.h>
